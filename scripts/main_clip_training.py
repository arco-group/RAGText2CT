...
from scripts.clip_training.utils.util import mkdir, set_seed, load_config_file  # noqa: E402
from scripts.clip_training.Clip_Training_Script import train  # noqa: E402
from core.cfg_helper import model_cfg_bank  # noqa: E402
from core.models.common.get_model import get_model  # noqa: E402
from scripts.clip_training.utils.logger import setup_logger  # noqa: E402

TRAINER_CONFIG_PATH = ROOT / "clip_train_config.yaml"
